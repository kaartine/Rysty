...
$username = "jukka";										/* The username. Case sensitive. */
$password = "jukka";										/* The password. Case sensitive */
$dir = "intranet";												/* The subdir name. This file has to be located 
...
$editphp = FALSE;											/* Decides if PHP files can be edited. FALSE on deafult. */
...
$allowedfile["xls"] = "application/octet-stream";				/* MS Excel document */
$allowedfile["odt"] = "application/vnd.oasis.opendocument.text";	/* Open office document */
$allowedfile["ods"] = "application/vnd.oasis.opendocument.spreadsheet";
